...
import com.stempien.uwielbiamzaczynacodpoczatku.HelloApplication;
import com.stempien.uwielbiamzaczynacodpoczatku.WindowType;
...
public class WindowHelper {
    ...
    public static void openWindow(WindowType windowType) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource(windowType.getViewPath()));
